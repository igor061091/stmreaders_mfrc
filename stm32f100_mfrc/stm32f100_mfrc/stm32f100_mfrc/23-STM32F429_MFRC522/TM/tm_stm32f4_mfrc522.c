...
void TM_MFRC522_InitPins(void) {
	...
	//CS pin
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_1 | GPIO_Pin_2 | GPIO_Pin_3 | GPIO_Pin_4| GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10;
	GPIO_Init(MFRC522_CS_PORT, &GPIO_InitStruct);	

	//MFRC522_CS_HIGH;
	   MFRC522_CS_PORT->BSRR = GPIO_Pin_1;		// reader 1
     MFRC522_CS_PORT->BSRR = GPIO_Pin_2;		// reader 2
     MFRC522_CS_PORT->BSRR = GPIO_Pin_3;    // reader 3
	   MFRC522_CS_PORT->BSRR = GPIO_Pin_4;    // reader 4
	   MFRC522_CS_PORT->BSRR = GPIO_Pin_8;    // reader 5  
	   MFRC522_CS_PORT->BSRR = GPIO_Pin_9;    // reader 6
	   MFRC522_CS_PORT->BSRR = GPIO_Pin_10;   // reader 7
}
